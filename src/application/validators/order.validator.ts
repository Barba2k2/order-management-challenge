...
export class OrderValidator {
  ...
  validateOrderCreation(
    ...
    return this.orderDomainService.validateOrderForCreation(lab, patient, customer, services);
  }
  ...
  validateStateTransition(currentState: string, targetState: string): boolean {
    ...
    const allowedTransitions = validTransitions[currentState as keyof typeof validTransitions];
